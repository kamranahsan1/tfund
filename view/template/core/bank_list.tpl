  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $insert; ?>" data-toggle="tooltip" title="<?php echo $button_insert; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-bank').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($bank['bank_id'], $selected)) { ?>
                  ...
                  <td class="text-right"><?php echo $bank['remarks']; ?></td>
                    <?php if($bank['status'] == 1){ ; ?>
                        <td class="text-left"><?php echo 'Active'; ?></td>
                    <?php }else{ ; ?>
                        <td class="text-left"><?php echo 'Deactive'; ?></td>
                    <?php } ; ?>
                  <td class="text-right"><a href="<?php echo $bank['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
