      ...
      <div class="panel-body">
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-fund">
          <div class="table-responsive">
                ...
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <td class="text-left"><?php if ($sort == 'column_fund_type') { ?>
		                ...
		                <?php } ?></td>
                    <td class="text-center"><?php if ($sort == 'fdate') { ?>
                    ...
                    <td class="text-center"><?php if ($sort == 'tdate') { ?>
		                ...
		                <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'assign_to') { ?>
                            <a href="<?php echo $sort_assign_to; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_assign_to; ?></a>
		                <?php } else { ?>
                            <a href="<?php echo $sort_assign_to; ?>"><?php echo $column_assign_to; ?></a>
		                <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($request['request_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $request['request_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $request['request_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $request['name']; ?></td>
                  <td class="text-left"><?php echo $request['sname']; ?></td>
                  <td class="text-left"><?php echo $request['fund_type_name']; ?></td>
                  <td class="text-left"><?php echo $request['fdate']; ?></td>
                  <td class="text-left"><?php echo $request['tdate']; ?></td>
                  <td class="text-left"><?php echo $request['assign_to']; ?></td>
            ...
            <?php } ; ?>
                  <td class="text-right"><a href="<?php echo $request['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
