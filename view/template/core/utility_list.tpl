                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php if ($sort == 'sname') { ?>
                                        ...
                                        <?php } ?></td>
                                    <td class="text-right"><?php if ($sort == 'added_date') { ?>
                                    ...
                                    <td class="text-right"><?php if ($sort == 'email') { ?>
                                        ...
                                        <?php } ?></td>
                                    <td class="text-right"><?php if ($sort == 'phone') { ?>
                                ...
                                <?php if ($utilities) { ?>
                                    <?php foreach ($utilities as $utility) { ?>
                                        <tr>
                                            <td class="text-center"><?php if (in_array($utility['utility_id'], $selected)) { ?>
                                                    <input type="checkbox" name="selected[]" value="<?php echo $utility['utility_id']; ?>" checked="checked" />
                                                <?php } else { ?>
                                                    <input type="checkbox" name="selected[]" value="<?php echo $utility['utility_id']; ?>" />
                                                <?php } ?></td>
                                            <td class="text-left"><?php echo $utility['name']; ?></td>
                                            <td class="text-left"><?php echo $utility['sname']; ?></td>
                                            <td class="text-right"><?php echo $utility['added_date']; ?></td>
                                            <td class="text-right"><?php echo $utility['email']; ?></td>
                                            <td class="text-right"><?php echo $utility['phone']; ?></td>
                                            <?php if($utility['status'] == 1){ ; ?>
                                                <td class="text-left"><?php echo 'Active'; ?></td>
                                            <?php }else{ ; ?>
                                                <td class="text-left"><?php echo 'Deactive'; ?></td>
                                            <?php } ; ?>
                                            <td class="text-right"><a href="<?php echo $utility['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
                                    <tr>
