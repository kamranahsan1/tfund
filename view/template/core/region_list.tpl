								...
								<?php if ($regions) { ?>
									<?php foreach ($regions as $region) { ?>
                                        <tr>
                                            ...
                                            <td class="text-left"><?php echo $region['sname']; ?></td>
                                            <td class="text-right"><?php echo $region['added_date']; ?></td>
                                            <td class="text-right"><?php echo $region['email']; ?></td>
                                            <td class="text-right"><?php echo $region['phone']; ?></td>
