      ...
      <div class="panel-body">
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-fund">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <td class="text-left"><?php if ($sort == 'date_added') { ?>
		                ...
		                <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'fmonth') { ?>
                            <a href="<?php echo $sort_fmonth; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_fmonth; ?></a>
		                <?php } else { ?>
                            <a href="<?php echo $sort_fmonth; ?>"><?php echo $column_fmonth; ?></a>
		                <?php } ?></td>

                    <td class="text-left"><?php if ($sort == 'tmonth') { ?>
                            <a href="<?php echo $sort_tmonth; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_tmonth; ?></a>
		                <?php } else { ?>
                            <a href="<?php echo $sort_tmonth; ?>"><?php echo $column_tmonth; ?></a>
		                <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $loan['sname']; ?></td>
                  <td class="text-left"><?php echo $loan['date_added']; ?></td>
                  <td class="text-left"><?php echo $loan['fmonth']; ?></td>
            ...
            <?php } ; ?>
                  <td class="text-right"><a href="<?php echo $loan['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
