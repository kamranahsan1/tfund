                            ...
                            <table class="table table-bordered table-hover">
								...
								<?php if ($investors) { ?>
									<?php foreach ($investors as $investor) { ?>
                                        <tr>
                                            <td class="text-center"><?php if (in_array($investor['investor_id'], $selected)) { ?>
                                                    <input type="checkbox" name="selected[]" value="<?php echo $investor['investor_id']; ?>" checked="checked" />
												<?php } else { ?>
                                                    <input type="checkbox" name="selected[]" value="<?php echo $investor['investor_id']; ?>" />
												<?php } ?></td>
                                            <td class="text-left"><?php echo $investor['name']; ?></td>
                                            <td class="text-left"><?php echo $investor['sname']; ?></td>
                                            <td class="text-right"><?php echo $investor['added_date']; ?></td>
                                            <td class="text-right"><?php echo $investor['email']; ?></td>
                                            <td class="text-right"><?php echo $investor['phone']; ?></td>
                                            <?php if($investor['status'] == 1){ ; ?>
                                                <td class="text-left"><?php echo 'Active'; ?></td>
                                            <?php }else{ ; ?>
                                                <td class="text-left"><?php echo 'Deactive'; ?></td>
                                            <?php } ; ?>
                                            <td class="text-right"><a href="<?php echo $investor['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
									<?php } ?>
								<?php } else { ?>
                                    <tr>
