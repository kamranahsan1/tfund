...
<section class="page1 page2">
	<div class="page1-sidebar">
		<ul>
			...
			<li class="active"><a href="http://localhost/webapplication/slide3.php"><img src="img/Group9810.png"></a></li>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="customer-btn">
						<a id="myBtn" href="javascript:;"><img src="img/ic_person_add_24px.png"> ADD NEW DRIVER</a>
					</div>
				</div>
			</div>
			<div class="row">
