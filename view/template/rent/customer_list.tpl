...
<div class="row">
    <div class="col-lg-6">
        <div class="page1-heading">
            <h2>Customer (<?php echo count($customers); ?>)</h2>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="customer-btn">
            <a href="<?php echo $insert; ?>"><img src="view/img/ic_person_add_24px.png"> ADD NEW CUSTOMER</a>
        </div>
    </div>
</div>
<div class="row">
...
<script type="text/javascript">
    $('input[name=\'search\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?route=rent/customer/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
                dataType: 'json',
    ...
    $('#button-filter').on('click', function() {
        ...
        location = 'index.php?route=rent/customer&token=<?php echo $token; ?>' + url;
    });
</script>
